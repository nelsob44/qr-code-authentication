    ...
    <section class="content-header">
        ...
        <h1 class="pull-right">            
            ...
            <input type="hidden" value="{{ $account->id }}" name="apply_for_payout">
                {!! Form::button('<i class="glyphicon glyphicon-ok"></i>Apply for payout', ['type' => 'submit', 'class' => 'btn btn-info btn-xs', 'onclick' => "return confirm('Are you sure you wish to ask for payout now?')"]) !!}
            ...
            <input type="hidden" value="{{ $account->id }}" name="mark_as_paid">
                {!! Form::button('<i class="glyphicon glyphicon-ok"></i>Approve as paid', ['type' => 'submit', 'class' => 'btn btn-primary btn-xs', 'onclick' => "return confirm('Are you sure you wish to confirm payout?')"]) !!}
